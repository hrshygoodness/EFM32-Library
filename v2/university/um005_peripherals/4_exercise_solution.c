...
static void ADCConfig(void)
{
  ...
  /* The TIMEBASE field has to be set to the number of clock cycles to achieve
   * at least 1 us delay. By calling ADC_TimebaseCalc with the argument 0, it
   * will calculate the required number of cycles based on the current frequency
   * of the high frequency peripheral clock, which is the clock connected
   * to the ADC. */
