...
static void DmaSetup(void)
{
  ...
  /*---------- Configure DMA channel 0 for USART Tx. ----------*/
  ...
  chnlCfgTx.select    = DMAREQ_USART1_TXBL;
  chnlCfgTx.cb        = &DmaTxCallBack;
  DMA_CfgChannel(0, &chnlCfgTx);

  /* Setup channel descriptor */
  /* Destination is USART Tx data register and doesn't move */
  ...
  /*---------- Configure DMA channel 1 for USART Rx. ----------*/
  ...
  chnlCfgRx.select    = DMAREQ_USART1_RXDATAV;
  chnlCfgRx.cb        = &DmaRxCallBack;
  DMA_CfgChannel(1, &chnlCfgRx);

  /* Setup channel descriptor */
  /* Source is USART Rx data register and doesn't move */
